...
with app.app_context():
    ...
    students = [
        {'student_id': '1', 'first_name': 'Robert', 'last_name': 'Smith',
         'email': 'robert.smith@example.edu',  # added email field
         'major_id': 3, 'birth_date': dt.datetime(year=2005, month=6, day=1), 'is_honors': 1},

        {'student_id': '2', 'first_name': 'Leo', 'last_name': 'Van Munching',
         'email': 'leo.vanmunching@example.edu',  # added email field
         'major_id': 6, 'birth_date': dt.datetime(year=2004, month=3, day=24), 'is_honors': 0}
    ]
    ...
    for each_student in students:
        ...
        a_student = Student(first_name=each_student["first_name"],
                            ...
                            email=each_student["email"],  # added email field
